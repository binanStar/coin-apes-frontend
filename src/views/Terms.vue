<template>
  <div class="container flex flex-col self-center justify-start text-white space-y-2 mt-8 mb-8">
    <h1 class="text-h1">Website Terms of Use</h1>

    <p>Version 1.0</p>

    <p>
      The Coin Apes website located at www.coinapes.com is a copyrighted work belonging to Coin
      Apes. Certain features of the Site may be subject to additional guidelines, terms, or rules,
    ...
    <p>
      ...
      to build a similar or competitive website; and (d) except as expressly stated herein, no part
    ...
    <p>
      ...
      its content are owned by Company or Company’s suppliers. Note that these Terms and access to
      the Site do not give you any rights, title or interest in or to any intellectual property
      rights, except for the limited access rights expressed in Section 2.1. Company and its
    ...
    <p>
      ...
      for third-parties.  Such Third-Party Links & Ads are not under the control of Company, and
      ...
      endorse, warrant, or make any representations with respect to Third-Party Links & Ads.  You
      use all Third-Party Links & Ads at your own risk, and should apply a suitable level of caution
    ...
    <p>
      ...
      Content, whether provided by you or by others.  You agree that Company will not be responsible
    ...
    <p>
      ...
      of action of every kind and nature, that has arisen or arises directly or indirectly out of,
      or that relates directly or indirectly to, the Site. If you are a California resident, you
      hereby waive California civil code section 1542 in connection with the foregoing, which
    ...
    <p>
      ...
      Like any other website, Coin Apes uses ‘cookies’. These cookies are used to store information
    ...
    <p>
      ...
      arising from or relating to these terms or your use of, or incapability to use the site even
      if company has been advised of the possibility of such damages.  Access to and use of the site
    ...
    <p>
      ...
      damages, costs and attorney’s fees incurred by us in connection with the written notification
    ...
    <p>
      ...
      with your most current e-mail address.  In the event that the last e-mail address that you
      ...
      to these Terms will be effective upon the earliest of thirty (30) calendar days following our
      dispatch of an e-mail notice to you or thirty (30) calendar days following our posting of
      notice of the changes on our Site.  These changes will be effective immediately for new users
      of our Site.  Continued use of our Site following notice of such changes shall indicate your
      acknowledgement of such changes and agreement to be bound by the terms and conditions of such
      changes. Dispute Resolution. Please read this Arbitration Agreement carefully. It is part of
    ...
    <p>
      ...
      Agreement.  Unless otherwise agreed to, all arbitration proceedings shall be held in English. 
      ...
      all authorized or unauthorized users or beneficiaries of services or goods provided under the
      Terms.
    </p>
    ...
    <p>
      ...
      requested relief.  A Notice to the Company should be sent to: Romania, Galati, Str. Nicolae
      Caranfil nr. 5c. After the Notice is received, you and the Company may attempt to resolve the
    ...
    <p>
      ...
      alternative dispute resolution provider that offers arbitration as set forth in this section. 
      If AAA is not available to arbitrate, the parties shall agree to select an alternative ADR
      Provider.  The rules of the ADR Provider shall govern all aspects of the arbitration except to
      the extent such rules are in conflict with the Terms.  The AAA Consumer Arbitration Rules
      governing the arbitration are available online at adr.org or by calling the AAA at
      1-800-778-7879.  The arbitration shall be conducted by a single, neutral arbitrator.  Any
      claims or disputes where the total amount of the award sought is less than Ten Thousand U.S.
      Dollars (US $10,000.00) may be resolved through binding non-appearance-based arbitration, at
      the option of the party seeking relief.  For claims or disputes where the total amount of the
      award sought is Ten Thousand U.S. Dollars (US $10,000.00) or more, the right to a hearing will
      be determined by the Arbitration Rules.  Any hearing will be held in a location within 100
      ...
      parties reasonable notice of the date, time and place of any oral hearings. Any judgment on
      the award rendered by the arbitrator may be entered in any court of competent jurisdiction. 
      If the arbitrator grants you an award that is greater than the last settlement offer that the
    ...
    <p>
      ...
      demanded within the statute of limitations and within any deadline imposed under the AAA Rules
      for the pertinent claim.
    </p>

    <p>
      <strong>Authority of Arbitrator.</strong>
      If arbitration is initiated, the arbitrator will decide the rights and liabilities of you and
      the Company, and the dispute will not be consolidated with any other matters or joined with
      ...
      award is based.  The arbitrator has the same authority to award relief on an individual basis
    ...
    <p>
      ...
      typically more limited, more efficient and less expensive than rules applicable in a court and
    ...
    <p>
      ...
      unenforceable by a court of competent jurisdiction, then such specific part or parts shall be
      of no force and effect and shall be severed and the remainder of the Agreement shall continue
      in full force and effect.
    </p>

    <p>
      <strong>Right to Waive.</strong>
      Any or all of the rights and limitations set forth in this Arbitration Agreement may be waived
      by the party against whom the claim is asserted.  Such waiver shall not waive or affect any
    ...
    <p>
      ...
      measures shall not be deemed a waiver of any other rights or obligations under this
    ...
    <p>
      ...
      in court, the parties hereby agree to submit to the personal jurisdiction of the courts
    ...
    <p>
      ...
      email. For contractual purposes, you (a) consent to receive communications from Company in an
      ...
      legal obligation that such communications would satisfy if it were be in a hard copy writing.
    </p>

    <p>
      <strong>Entire Terms.</strong>
      These Terms constitute the entire agreement between you and us regarding the use of the Site.
      Our failure to exercise or enforce any right or provision of these Terms shall not operate as
      a waiver of such right or provision. The section titles in these Terms are for convenience
      ...
      provisions of these Terms will be unimpaired and the invalid or unenforceable provision will
      be deemed modified so that it is valid and enforceable to the maximum extent permitted by
      law.  Your relationship to Company is that of an independent contractor, and neither party is
      an agent or partner of the other.  These Terms, and your rights and obligations herein, may
    ...
    <p>
      ...
      these Marks without our prior written consent or the consent of such third party which may own
      the Marks.
    </p>

    <h2>Contact Information</h2>

    <p>Address: Romania, Galati, Str. Nicolae Caranfil nr. 5c</p>
    <p>Email: coinapes.contact@gmail.com</p>
  </div>
</template>
...
p,
li {
  @apply text-sm lg:text-base text-white font-normal;
}

h2 {
  @apply text-base lg:text-xl text-white font-medium mb-4 mt-4;
}
</style>