<template>
  <div class="container flex flex-col self-center justify-start text-white space-y-2 mt-8 mb-8">
    <h1 class="text-h1">Privacy Policy for Coin Apes</h1>

    <p>
      At Coin Apes, accessible from www.coinapes.com, one of our main priorities is the privacy of
      our visitors. This Privacy Policy document contains types of information that is collected and
      recorded by Coin Apes and how we use it.
    </p>
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in Coin Apes. This
    ...
    <p>
      Coin Apes follows a standard procedure of using log files. These files log visitors when they
    ...
    <p>
      ...
      <a href="https://www.privacypolicyonline.com/what-are-cookies/" class="text-violet">
        "What Are Cookies"
      </a>
      .
    </p>
    ...
    <p>
      ...
      Beacons that are used in their respective advertisements and links that appear on Coin Apes,
    ...
    <p>
      Note that Coin Apes has no access to or control over these cookies that are used by
    ...
    <p>
      Coin Apes's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>
      Coin Apes does not knowingly collect any Personal Identifiable Information from children under
